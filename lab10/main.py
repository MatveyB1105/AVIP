...
def spectrogram_plot(samples, sample_rate,t = 11000):
    ...
    plt.pcolormesh(times, frequencies, spec, shading='gouraud', vmin=spec.min(), vmax=spec.max(), cmap='inferno')
...
if __name__ == '__main__':
   ...
   plt.axhline(y = 86,  color = 'g', linestyle = '-', lw= 0.5, label = "Форманты")
   plt.axhline(y = 344,  color = 'g', linestyle = '-', lw= 0.5)
   plt.axhline(y = 602,  color = 'g', linestyle = '-', lw= 0.5)
   plt.axhline(y = 861,  color = 'g', linestyle = '-', lw= 0.5)
   plt.legend()
   ...
   plt.axhline(y = 344,  color = 'g', linestyle = '-', lw= 0.5)
   plt.axhline(y = 602,  color = 'g', linestyle = '-', lw= 0.5)
   plt.axhline(y = 3186,  color = 'g', linestyle = '-', lw= 0.5)
   plt.legend()
